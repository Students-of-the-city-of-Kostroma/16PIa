...
namespace SimpleLexer
{
    public class Lexer : ILexer
    {
        ...
        public Lexer(string name, string operations, bool T)
        {

            new TokenDefinition(name, new Regex(operations), T);

        }

        public Lexer(string name, string operations)
        {

            new TokenDefinition(name, new Regex(operations));
